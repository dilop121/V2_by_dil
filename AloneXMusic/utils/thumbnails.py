...
async def get_thumb(videoid):
    if os.path.isfile(f"cache/{videoid}_{app.id}.png"):
       return f"cache/{videoid}_{app.id}.png"
    ...
    try:
        ...
        try:
            ...
            pass
        background.save(f"cache/{videoid}_{app.id}.png")
        return f"cache/{videoid}_{app.id}.png"
    except Exception:
